...
Создадим локальный репозиторий.
![репозиторий](image/2.1.jpg){#fig:001 width=70%} 
Сначала сделаем предварительную конфигурацию, указав имя и email владельца репозитория:
Для инициализации локального репозитория, расположенного, например, в каталоге ~/tutorial, необходимо ввести в командной строке
После это в каталоге tutorial появится каталог .git, в котором будет храниться история изменений.
...
Воспользуемся командой status для просмотра изменений в рабочем каталоге, сделанных с момента последней ревизии:
 ...
 ![](image/3.2.jpg){#fig:001 width=70%} 
 ![](image/2.3.jpg){#fig:001 width=70%} 
 ![](image/2.4.jpg){#fig:001 width=70%} 

2. Работа с сервером репозиториев
Для последующей идентификации пользователя на сервере репозиториев необходимо сгенерировать пару ключей (приватный и открытый):
    
    ![](image/2.5.jpg){#fig:001 width=70%} 
3. Базовая настройка git

Первичная настройка параметров git

  ![](image/2.6.jpg){#fig:001 width=70%} 
4. Учёт переносов строк
Посмотреть значения переносов строк в репозитории можно командой
![](image/2.7.jpg){#fig:001 width=70%} 

5. Создание ключа ssh

    ![](image/2.8.jpg){#fig:001 width=70%} 
    
6. Верификация коммитов с помощью PGP
Как настроить PGP-подпись коммитов с помощью gpg.
Создание ключа

    Генерируем ключ, Экспорт ключа

    Выводим список ключей и копируем отпечаток приватного ключа:
  ![](image/2.9.jpg){#fig:001 width=70%} 
...
![](image/2.10.jpg){#fig:001 width=70%} 
